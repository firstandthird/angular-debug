module.exports = function(grunt) {
  grunt.initConfig({
    ...
    concat: {
      ...
      dist: {
        src: [
          'lib/angular-debug.js'
        ],
        dest: 'dist/angular-debug.js'
      },
      full: {
        src: [
          'dist/_bower.js',
        ...
        dest: 'dist/angular-debug.full.js'
      }
    },
    uglify: {
      options: {
      ...
      dist: {
        src: 'dist/angular-debug.js',
        dest: 'dist/angular-debug.min.js'
      },
      full: {
        src: 'dist/angular-debug.full.js',
        dest: 'dist/angular-debug.full.min.js'
      }
    },
    clean: {
      bower: [
